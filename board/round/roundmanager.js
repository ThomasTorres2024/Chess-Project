...
export default class RoundManager
{
    ...
    {   
        ...
        this.currentRound = new CastleRound(this.previousRound, kingOldSquare,kingNewSquare, king, rookOldSquare, rookNewSquare, rook, this.board,this.count,this.turnColor)
    }
    ...
    addToRounds(oldSquare,newSquare,piece)
    {   
        //if the round head hasn't been established yet, establish it
        if(this.roundHead != null)
        {
            this.createNewRoundCore();
            this.currentRound = new Round(this.previousRound,oldSquare,newSquare,this.board,this.count,this.currentColor,piece);
        }
        else
        {
