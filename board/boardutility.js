...
/**
 * Async function for getting info on next best move from Stockfish directly
 * @param {Fen string with corresponding data} data 
 * @returns Move info for next best move according to Stockfish
 * 
 * Example usage:
 * 
 *      postChessApi({ fen: "rnbqkb1r/ppp2ppp/3p1n2/4p3/4P3/3P1P2/PPP1N1PP/RNBQKB1R b KQkq - 1 4" }).then((data) => {
                console.log(data);
        });
 */
